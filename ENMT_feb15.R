...
ps.id.test1<-identity.test(Pinus,Suillus,RCP4.5INMCM42055,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id0") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test1, file="id.test0.rda")
ps.bg.test1<-background.test(Pinus,Suillus,RCP4.5INMCM42055, type="mx", nreps=100, low.memory=TRUE,  rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg0") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur. 
...
ps.id.test2<-identity.test(Pinus,Suillus,RCP8.5INMCM42055,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id1") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test2, file="id.test1.rda")
ps.bg.test2<-background.test(Pinus,Suillus,RCP8.5INMCM42055, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg1") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur.
...
ps.id.test3<-identity.test(Pinus,Suillus,RCP4.5INMCM42085,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id2") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test3, file="id.test2.rda")
ps.bg.test3<-background.test(Pinus,Suillus,RCP4.5INMCM42085, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg2") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur.
...
ps.id.test4<-identity.test(Pinus,Suillus,RCP8.5INMCM42085,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id3") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test4, file="id.test3.rda")
ps.bg.test4<-background.test(Pinus,Suillus,RCP8.5INMCM42085, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg3") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur. 
...
ps.id.test5<-identity.test(Pinus,Suillus,RCP4.5CCSM42055,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id4") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test5, file="id.test4.rda")
ps.bg.test5<-background.test(Pinus,Suillus,RCP4.5CCSM42055, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg4") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur. 
...
ps.id.test6<-identity.test(Pinus,Suillus,RCP8.5CCSM42055,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id5") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test6, file="id.test5.rda")
ps.bg.test6<-background.test(Pinus,Suillus,RCP8.5CCSM42055, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg5") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur. 
...
ps.id.test7<-identity.test(Pinus,Suillus,RCP4.5CCSM42085,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id6") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test7, file="id.test6.rda")
ps.bg.test7<-background.test(Pinus,Suillus,RCP4.5CCSM42085, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg6") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur. 
...
ps.id.test8<-identity.test(Pinus,Suillus,RCP8.5CCSM42085,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id7") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test8, file="id.test7.rda")
ps.bg.test8<-background.test(Pinus,Suillus,RCP8.5CCSM42085, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg7") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur. 
...
ps.id.test9<-identity.test(Pinus,Suillus,RCP8.5GFDLCM32055,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id8") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test9, file="id.test8.rda")
ps.bg.test9<-background.test(Pinus,Suillus,RCP8.5GFDLCM32055, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg8") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur.
...
ps.id.test10<-identity.test(Pinus,Suillus,RCP4.5GFDLCM32055,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id9") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test10, file="id.test9.rda")
ps.bg.test10<-background.test(Pinus,Suillus,RCP4.5GFDLCM32055, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg9") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur. 
...
ps.id.test11<-identity.test(Pinus,Suillus,RCP4.5GFDLCM32085,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id10") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test11, file="id.test10.rda")
ps.bg.test11<-background.test(Pinus,Suillus,RCP4.5GFDLCM32085, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg10") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur. 
...
ps.id.test12<-identity.test(Pinus,Suillus,RCP8.5GFDLCM32085,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id11") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test12, file="id.test11.rda")
ps.bg.test12<-background.test(Pinus,Suillus,RCP8.5GFDLCM32085, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg11") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur. 
...
ps.id.test13<-identity.test(Pinus,Suillus,CurrentNormal,type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/id12") #null hypothesis that the two species' occurrences in the environment are effectively a random draw from the same underlying distribution. Note that niche evolution is only one of many reasons why two species' realized environmental distributions might cause departures from this null hypothesis (Warren et al. 2014)
save(ps.id.test13, file="id.test12.rda")
ps.bg.test13<-background.test(Pinus,Suillus,CurrentNormal, type="mx", nreps=100, low.memory=TRUE, rep.dir="/Volumes/S&V_LineaPro_Apr2012/posthoc/bg12") #The purpose of this test is to correct for the availability of habitat and ask whether the observed similarity between species or populations is significantly more (or less) than expected given the available set of environments in the regions in which they occur. 
